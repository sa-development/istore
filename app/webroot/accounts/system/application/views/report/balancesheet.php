<?php
	...
	$liability->init(2);
	echo "<table border=0 cellpadding=5 class=\"grid simple-table balance-sheet-table\" width=\"100%\">";
	...
	echo "<td>";
	echo "<table border=0 cellpadding=5 class=\"grid balance-sheet-total-table\" width=\"100%\">";
	echo "<tr valign=\"top\">";
