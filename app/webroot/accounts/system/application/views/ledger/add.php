<?php
	...
	echo "<p>";
	echo form_label('Account Type', 'ledger_group_id');
	echo "<br />";
	...
	echo "<p>";
	echo form_label('Account name', 'ledger_name');
	echo "<br />";
	echo form_input($ledger_name);
	echo "</p>";

	echo "<p>";
	echo form_label('Sub Account', 'parent_id');
	echo "<br />";
	echo form_dropdown('parent_id', $parent_id, 1);
	echo "</p>";
