...
<table cellpadding="0" cellspacing="0" class="grid">
	<dl>
		...
		<dd>
			<?php echo h($fuelInvoice['PaymentMethod']['name']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h(ucfirst($fuelInvoice['FuelInvoice']['status'])); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Gas Dilivered in Gallon'); ?></th>
	...
	<?php
		...
		<tr>
			...
			<td><?php echo $fuelType[$fuelInvoiceItem['fuel_type_id']]; ?></td>
