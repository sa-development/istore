    ...
    <table cellpadding="0" cellspacing="0" class="grid">
        <tr>
            ...
            <th><?php echo $this->Paginator->sort('SellUnit'); ?></th>
             <?php /*<th><?php echo $this->Paginator->sort('sysid'); ?></th>
...
<?php echo $this->Html->link($plus['Station']['name'], array('controller' => 'stations', 'action' => 'view', $plus['Station']['id'])); ?>
            ...
            <?php /* <td><?php echo h($plus['Plus']['sysid']); ?>&nbsp;</td>
            <td><?php echo h($plus['Plus']['sysid2']); ?>&nbsp;</td>
            <td><?php echo h($plus['Plus']['sysid3']); ?>&nbsp;</td>
            <td><?php echo h($plus['Plus']['sysid4']); ?>&nbsp;</td> */?>
            
            <td class="actions">
<?php echo $this->Html->link(__('View'), array('controller' => 'pluses', 'action' => 'view', $plus['Plus']['id'])); ?>
                <?php echo $this->Html->link(__('Edit'), array('controller' => 'pluses','action' => 'edit', $plus['Plus']['id'])); ?>
                <?php echo $this->Form->postLink(__('Delete'), array('controller' => 'pluses','action' => 'delete', $plus['Plus']['id']), null, __('Are you sure you want to delete # %s?', $plus['Plus']['id'])); ?>
            </td>
        </tr>
<?php endforeach; ?>
    </table>
...
?>
        ...
        <div class="actions">
            <h3><?php echo __('PLU'); ?></h3>
                    <ul>
                      <li><?php echo $this->Html->link(__('New Plus'), array('controller' => 'pluses', 'action' => 'add')); ?></li>
