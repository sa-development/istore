...
<?php echo $this->Form->create('Vrubyrepttax'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vrubyrepttax'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vrubyrepttax.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vrubyrepttax.id'))); ?></li>
