...
<?php echo $this->Form->create('Vrubyreptdeal'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vrubyreptdeal'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vrubyreptdeal.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vrubyreptdeal.id'))); ?></li>
