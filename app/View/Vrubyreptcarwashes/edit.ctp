...
<?php echo $this->Form->create('Vrubyreptcarwash'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vrubyreptcarwash'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vrubyreptcarwash.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vrubyreptcarwash.id'))); ?></li>
