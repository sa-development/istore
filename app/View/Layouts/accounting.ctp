        ...
        <body>
            ...
            <?php echo $this->element('sub-menu');?>
			  <div>
				...
				?>     
				<iframe width="100%" seamless="seamless" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" scrolling="no" height="1800px" src="http://istoreoffice.net/app/webroot/accounts/index.php"></iframe>
                </div>
