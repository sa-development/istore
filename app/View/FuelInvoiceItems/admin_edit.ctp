...
<?php echo $this->Form->create('FuelInvoiceItem'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Fuel Invoice Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FuelInvoiceItem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FuelInvoiceItem.id'))); ?></li>
