...
<?php echo $this->Form->create('Paybill'); ?>
	<fieldset>
		<legend><?php echo __('Edit Paybill'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Paybill.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Paybill.id'))); ?></li>
