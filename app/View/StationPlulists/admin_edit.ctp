...
<?php echo $this->Form->create('StationPlulist'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Station Plulist'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('StationPlulist.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('StationPlulist.id'))); ?></li>
