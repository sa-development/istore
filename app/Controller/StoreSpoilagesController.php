 ...
 */
	public function add() {
		...
		// function preparedDataForSaveAll is declare in AppController & use to save multi-pal data received.
			...
			$ssitems = $this->preparedDataForSaveAll('StoreSpoilage');
		    $this->request->data['StoreSpoilage'] = $ssitems['StoreSpoilage'];	
			$this->StoreSpoilage->create();
			if ($this->StoreSpoilage->saveAll($this->request->data['StoreSpoilage'])) {
		...
		$this->set(compact('categories','vrubyreptplus'));
	}
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			if ($this->StoreSpoilage->saveAll($this->request->data)) {
				$this->Session->setFlash(__('The store spoilage has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The store spoilage could not be saved. Please, try again.'));
