 ...
 */
	public function add() {
		...
		/* function preparedDataForSaveAll is declare in AppController & use to save multi-pal data received. */
		    $psitems = $this->preparedDataForSaveAll('StorePricechange');
			$this->request->data['StorePricechange'] = $psitems['StorePricechange'];
					
			$this->StorePricechange->create();
			if ($this->StorePricechange->saveAll($this->request->data['StorePricechange'])) {
