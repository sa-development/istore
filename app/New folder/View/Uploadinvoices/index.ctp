<div class="uploadinvoices index">
	<h2><?php echo __('Uploadinvoices'); ?></h2>
	...
	<tr>
		...
		<td><?php echo $this->Html->link($uploadinvoice['Uploadinvoice']['file'], '/files/uploads/'.$uploadinvoice['Uploadinvoice']['file']); ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $uploadinvoice['Uploadinvoice']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $uploadinvoice['Uploadinvoice']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $uploadinvoice['Uploadinvoice']['id']), null, __('Are you sure you want to delete # %s?', $uploadinvoice['Uploadinvoice']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
