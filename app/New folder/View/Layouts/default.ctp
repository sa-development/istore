...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php
            ...
            echo $this->Html->css('cake.generic.treplex-v4');
            ...
            <div id="container">
                <div id="header">
                    ...
                    if (isset($userInfo['id']) && $userInfo['id'] > 0) {
						...
						?>
						<a href="<?php echo $this->Html->url(array('controller' => 'dashboards', 'action' => 'index'));?>"><img src="img/home_w.png" width="20"></a>
						<a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'logout'));?>"><img src="img/logout-h.png" width="20"></a>
