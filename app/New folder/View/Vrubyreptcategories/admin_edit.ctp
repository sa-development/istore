<div class="vrubyreptcategories form">
<?php echo $this->Form->create('Vrubyreptcategory'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Vrubyreptcategory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vrubyreptcategory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vrubyreptcategory.id'))); ?></li>
